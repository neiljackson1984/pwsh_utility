...
function Start-AutodeskPopupSlapdown(){
    ...
    $popupSlapdownScriptContent = (
        @(
            ...
            "GroupAdd, anyPopupWindowDefinition                ,ahk_group revitOrAutocadPrivacyWindowDefinition                                                     "
            ...
            "    } else if WinExist(`"ahk_group revitOrAutocadPrivacyWindowDefinition`") {                                                                         "
            "        writeToLog(`"slapping down revitOrAutocadPrivacy`")                                                                                           "
